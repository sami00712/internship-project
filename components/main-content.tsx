    ...
    <div className="max-w-7xl mx-auto px-4 py-6">
      ...
      <div className="mt-16">
        ...
        <div className="grid grid-cols-5 gap-6">
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-4">
            <div className="mb-4">
              <Image src="/image/1.jpg" alt="T-shirt" width={160} height={160} className="w-full h-40 object-contain" />
            </div>
            <p className="text-lg font-semibold text-gray-900 mb-2">$10.30</p>
            <p className="text-sm text-gray-600">T-shirts with multiple colors, for men</p>
          </div>
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-4">
            <div className="mb-4">
              <Image src="/image/7.jpg" alt="Jacket" width={160} height={160} className="w-full h-40 object-contain" />
            </div>
            <p className="text-lg font-semibold text-gray-900 mb-2">$10.30</p>
            <p className="text-sm text-gray-600">Jeans shorts for men blue color</p>
          </div>
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-4">
            <div className="mb-4">
              <Image src="/image/3.jpg" alt="Suit" width={160} height={160} className="w-full h-40 object-contain" />
            </div>
            <p className="text-lg font-semibold text-gray-900 mb-2">$12.50</p>
            <p className="text-sm text-gray-600">Brown winter coat medium size</p>
          </div>
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-4">
            <div className="mb-4">
              <Image src="/image/5.jpg" alt="Wallet" width={160} height={160} className="w-full h-40 object-contain" />
            </div>
            <p className="text-lg font-semibold text-gray-900 mb-2">$34.00</p>
            <p className="text-sm text-gray-600">Jeans bag for travel for men</p>
          </div>
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-4">
            <div className="mb-4">
              <Image src="/image/6.jpg" alt="Pot" width={160} height={160} className="w-full h-40 object-contain" />
            </div>
            <p className="text-lg font-semibold text-gray-900 mb-2">$10.30</p>
            <p className="text-sm text-gray-600">Blue wallet for men leather metarial</p>
          </div>
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-4">
            <div className="mb-4">
              <Image src="/image/5.jpg" alt="Kettle" width={160} height={160} className="w-full h-40 object-contain" />
            </div>
            <p className="text-lg font-semibold text-gray-900 mb-2">$80.95</p>
            <p className="text-sm text-gray-600">Jeans bag for travel for men</p>
          </div>
